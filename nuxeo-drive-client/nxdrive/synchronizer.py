...
class Synchronizer(object):
    ...
    def scan_local(self, server_binding_or_local_path, from_state=None,
        ...
        client = self.get_local_client(server_binding)
    ...
    def synchronize_one(self, doc_pair, session=None):
        ...
        local_client = self.get_local_client(doc_pair.server_binding)
    ...
    def get_local_client(self, server_binding):
        return self._controller.get_local_client(server_binding)
